...
pub const CONFIDENTIAL_CLIENT_MANAGED_IDENTITY_TAG: &str = "confidential_client_managed_identity";
pub const DEFAULT_MANAGED_IDENTITY_FIC_RESOURCE: &str = "api://AzureADTokenExchange";
